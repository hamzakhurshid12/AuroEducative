...
function drawGround(d, hFactor, h, x, y,)  {
  ground1 = new component( 940, 80, '#684027',x, y); //w,h,color,x,y
  ground2 = new component( 940, 20, 'green', x, y);

  //Stairs 10 step
  obsground1 = new component( 1180,h, "#a874b3",120 , 400); //w, h , color, x,y
  obsground2 = new component(1130, h,"#b8639a", 200 + hFactor, 360);
  obsground3 =new component(1080,h,"#ba4e5d",280 + hFactor,320);
  obsground4 = new component( 1080,h, "#8c434b",360 + hFactor, 280);
  obsground5 = new component(1080, h,"#D5D500", 440 + hFactor, 240);
  obsground6 =new component(1080,h,"#94E000",520 + hFactor,200);
  obsground7 = new component( 1080,h, "#54AA10",600 + hFactor, 160);
  obsground8 = new component(1080, h,"#67DCE2", 680 + hFactor, 120);
  obsground9 =new component(1080,h,"#226EAA",760 + hFactor,80);
  obsground10 =new component(1080,h,"#624e99",840 + hFactor,40);


  // 10 food items
  var pineW = 30; var pineH = 35;
  var appleW = 30; var appleH = 35;
  key1 = new keycomponent(appleW,appleH,140,355, apple_img, counts[0]); //w, h,  x,y , img, obj
  key2 = new keycomponent(pineW,pineH,220,355 - d, pine_img, counts[1]);
  key3 = new keycomponent(appleW,appleH,300,315  - d, apple_img, counts[2]);
  key4 = new keycomponent(appleW,appleH,380,275 - d, apple_img, counts[3]); 
  key5 = new keycomponent(pineW,pineH,460, 235 - d, pine_img, counts[4]);
  key6 = new keycomponent(pineW,pineH,540,195 - d, pine_img, counts[5]);
  key7 = new keycomponent(appleW,appleH,620,155 - d, apple_img, counts[6]); 
  key8 = new keycomponent(pineW,pineH,700,115 - d, pine_img, counts[7]);
  key9 = new keycomponent(pineW,pineH,780,75 - d, pine_img, counts[8]);
  key10 = new keycomponent(pineW,pineH,860,35 - d, pine_img, counts[9]);
...
function mainLoop() { // time passed by requestAnimationFrame        
  ...
  drawGround(35,1, 35,0, model.ground);
  character.update();
